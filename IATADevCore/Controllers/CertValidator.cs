namespace IATADevCore.Controllers
{
    ...
    class CertValidator
    {
        ...
        public CertValidator(IConfiguration configuration){
        ...
        string CachedFolder
        {
            get
            {
                return _configuration["CachedFolder"];
            }
        }
        ...
        /// <param name="cert"></param>
        /// <returns></returns>
        IList<string> ParseOneRecordIDs(System.Security.Cryptography.X509Certificates.X509Certificate2 cert)
        {
            var bc = (new Org.BouncyCastle.X509.X509CertificateParser()).ReadCertificate(cert.RawData);
